...
const Signup = () => {
    ...
    return (
        <div className='dark:bg-neutral-900 dark:text-white bg-white text-neutral-900  h-screen flex items-center md:px-48 2xl:px-0 2xl:max-w[1440px] max-w-7xl mx-auto font-primary'>
            <div className='flex flex-col lg:flex-row lg:justify-between dark:bg-neutral-800 bg-gray-200 p-8 md:rounded-2xl gap-4 lg:gap-10 w-full'>
